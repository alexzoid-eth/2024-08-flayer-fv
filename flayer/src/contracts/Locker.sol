...
contract Locker is AirdropRecipient, ILocker, Pausable {
    ...
    /**
     * Allows a {CollectionShutdown} contract to be set. This will be the only contract
    ...
    /**
     * Allows a {CollectionShutdown} contract to be set. This will be the contract that
