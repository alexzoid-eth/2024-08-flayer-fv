...
/// https://github.com/RevelationOfTuring/foundry-openzeppelin-contracts/blob/master/test/token/ERC20/extensions/ERC20Votes.t.sol
contract CollectionTokenVotesTest is FlayerTest {
    ...
    function test_Delegate() external {
        ...
        CollectionToken.Checkpoint memory ckpt = _testing.checkpoints(user2, 0);
    ...
    function test_MintAndBurnAndMaxSupply() external {
        ...
        vm.prank(user1);
        _testing.approve(address(this), 1);
