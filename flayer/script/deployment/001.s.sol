 ...
 *
 * forge script script/deployment/001.s.sol:PlatformDeployment001 --rpc-url "https://base-sepolia.g.alchemy.com/v2/rdDHzobYbX05hT1N4zJ3k79uYOX5xvX-" --broadcast -vvvv --optimize --optimizer-runs 1000 --memory-limit 50000000000
 */
contract PlatformDeployment001 is Script {
    ...
    address payable internal constant UNISWAP_V4_POOL_MANAGER = payable(0xA327CF1C98bB288F0Da3F3Fa4fde7d661Fc569e8);
    ...
    function run() external {
        ...
        // Update our UniswapImplementation owner
        BaseImplementation(uniswapImplementation).initialize(Locker(locker).owner());
        ...
        // Create our {TaxCalculator}
        TaxCalculator taxCalculator = new TaxCalculator();
        Locker(locker).setTaxCalculator(address(taxCalculator));

        console.log('================');
        console.log('PoolManager', UNISWAP_V4_POOL_MANAGER);
        console.log('collectionToken', collectionToken);
        console.log('lockerManager', lockerManager);
        console.log('locker', locker);
        console.log('uniswapImplementation', uniswapImplementation);
        console.log('listings', listings);
        console.log('protectedListings', protectedListings);
        console.log('linearRangeCurve', RANGE_CURVE);
        console.log('collectionShutdown', collectionShutdown);
        console.log('taxCalculator', address(taxCalculator));
        console.log('================');
